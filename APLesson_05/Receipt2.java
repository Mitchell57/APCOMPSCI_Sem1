...
public class Receipt2 {
	public static void main(String [] args){
		...
		Receipt2.printReceipt(items, prices,
		Receipt2.calcTotals(prices), Receipt2.discount(Receipt2.calcTotals(prices)[0]));
	}
	public static void printReceipt(String[] items, double[] prices, double[] totals, boolean discount){
		...
		System.out.printf("*\n* %18s ........    %3.2f\n", "Subtotal", totals[0]);
		if(discount){
			System.out.printf("* %18s ........    %3.2f\n", "Discount", totals[0]*.15);
		}
		System.out.printf("* %18s ........    %3.2f\n", "Tax", totals[1]);
		System.out.printf("* %18s ........    %3.2f\n", "Total", totals[2]-(totals[0]*.15));
	...
	public static boolean discount(double total){
